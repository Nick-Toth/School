(* This file was written almost entirely by someone I don't know.
It was provided to me in my CIS425 course.
All (hopefully) of my changes are labeled (* added by ngt *).
See interp.sml for more info.
*)
...
datatype term = AST_ID of string
              ...
              (* added by ngt *)
              | AST_MUL (* ( * operator ) *)
              | AST_DIV (* ( / operator ) - produces a rational number type, defined in interp.sml *)
              | AST_LESS (* ( < operator ) *)
              ...
              (* Recursion? Yes. But ignore it - Oct 19 lec, 00:37:33. *)
...
struct
  ...
  *)
  fun parseExp (ID v::tail)  = (AST_ID v, tail)
    ...
    | parseExp (MULSYM::tail) = (AST_MUL, tail)  (* added by ngt *)
    | parseExp (DIVSYM::tail) = (AST_DIV, tail)  (* added by ngt *)
    | parseExp (LESSSYM::tail) = (AST_LESS, tail) (* added by ngt *)
